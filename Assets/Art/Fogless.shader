...
Shader "New Amplify Shader"
{
	...
	SubShader
	{
		...
		{
			float4 color1 = IsGammaSpace() ? float4(0.5377358,0.5377358,0.5377358,0) : float4(0.2506461,0.2506461,0.2506461,0);
			o.Emission = ( color1 * ( 2.0 * _SinTime.w ) ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=17000
6.4;0.8;1524;796;915.4298;255.3489;1;True;True
Node;AmplifyShaderEditor.SinTimeNode;2;-464,169;Float;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;4;-425.4298,384.6511;Float;False;Constant;_Float0;Float 0;0;0;Create;True;0;0;False;0;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;1;-510,-82.5;Float;False;Constant;_Color0;Color 0;0;1;[HDR];Create;True;0;0;False;0;0.5377358,0.5377358,0.5377358,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;3;-311,124;Float;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;5;-150.4298,24.15109;Float;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=C51F193836B9C9F9AFB98A9A2BE2C9FC4FAFD4C1